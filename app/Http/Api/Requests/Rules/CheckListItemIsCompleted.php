...
final class CheckListItemIsCompleted implements RuleInterface
{
    public function name(): string
    {
        return 'list_item_completed';
    }
    ...
    public function validate(string $field, mixed $value, array $data, Request $request): void
    {
        ...
        if ($row !== null && !(bool) ($row['is_completed'] ?? false)) {
            throw new ValidationError('Only completed list items can be restored.');
        }
    }
}
