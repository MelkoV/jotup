...
use App\Data\ListItem\UncompleteRequestData;
...
use App\Http\Api\Requests\Rules\CheckListItemIsCompleted;
use Jotup\Http\Request\Request;
use Jotup\Http\Request\Validation\Rule;

final class UncompleteRequest extends Request
{
    public function rules(): array
    {
        return [
            'id' => ['required', 'uuid', 'bail', new CheckCanEditListByItem(), new CheckListItemBelongsToNonTemplateList(), new CheckListItemIsCompleted()],
    ...
    public function toData(): UncompleteRequestData
    {
        return UncompleteRequestData::from($this->validated());
    }
}
